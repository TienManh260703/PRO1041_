...
//
//                ImageData imageData = ImageDataFactory.create(getClass().getResource("/raven.icon.png"));
...
//                if (hoaDon.getIdKH().getMaKhachHang()== null) {
...
//                        + (hoaDon.getPhuongThucTT()== 0 ? "Tiền mặt" :hoaDon.getPhuongThucTT()== 1 ? "\nChuyển khoản:" :"Kết hợp")
//      
//                        + "\nTổng tiền khách đưa:"
//                        + "\nTrả lại:")
//                        .setFont(fontTitle)
